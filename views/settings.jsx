      ...
      <table className="settingsTable">
        ...
        <tr className="settingsTableRow">          
          ...
          <td className="settingCol2">
            ...
            <input className="settingsInput" type="text" size="22" id="userNodeURL" name="userNodeURL" placeholder={!userDefinedNodeURL ? App.getRestService() : undefined} defaultValue={userDefinedNodeURL ? App.getCurrentNodeURL() : undefined} onChange={(e) => changeUserNodeURL()} />        
          </td>
